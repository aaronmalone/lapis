...
public class LapisTransmissionRestletClientImpl extends LapisTransmissionBaseImpl {
	
	private final Logger logger = Logger.getLogger(getClass());
	
	public ClientResponse executeClientCall(ClientCall clientCall) {
		System.out.println("using rest client"); //TODO REMOVE
	...
	private Representation createRestletRepresentation(ClientCall clientCall) {
		return new ByteArrayRepresentation(clientCall.getPayload());
	}
